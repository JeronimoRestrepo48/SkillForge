...
urlpatterns = [
    ...
    path('wishlist/toggle/<int:pk>/', views.WishlistToggleView.as_view(), name='wishlist_toggle'),
    path('industry-certifications/', views.CertificacionesIndustriaListView.as_view(), name='certificaciones_industria'),
    path('industry-certifications/<slug:slug>/', views.CertificacionIndustriaDetailView.as_view(), name='certificacion_industria_detail'),
    path('industry-certifications/<slug:slug>/buy/', views.ComprarCertificacionView.as_view(), name='comprar_certificacion'),
    path('industry-certifications/<slug:slug>/exam/', views.ExamenCertificacionView.as_view(), name='examen_certificacion'),
    path('industry-certifications/<slug:slug>/diploma/pdf/', views.DiplomaCertificacionPdfView.as_view(), name='diploma_certificacion_pdf'),
]
